...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/15 14:54:27 by dberehov          #+#    #+#             */
/*   Updated: 2023/05/15 14:54:27 by dberehov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Picks the best target position in stack A for the given rank of an element in stack B.
int		fetch_target(t_stack **a, int b_rank, int t_rank, int t_position)
{
	t_stack	*temp_a;

	temp_a = *a;// Pointer to the head of the stack A.
	while (temp_a)// Loop to find the max rank.
	{
	...
	if (t_rank != INT_MAX)
		return (t_position);
	temp_a = *a;
	while (temp_a)// Loop to find the lowest rank.
	{
	...
	return (t_position);// Return the lowest rank found.
}
...
int	low_rank_pos(t_stack **stack)
{
	...
	while (temp)// Loop and save the position of the lowest rank.
	{
